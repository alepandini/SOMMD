...
trj2pdb(traj = trj, frame=NEUR_repres[8], filename = "./01_FOXP1_dataset/Neuron_8.pdb")

#Estract the representative conformation of Cluster B
trj2pdb(traj = trj, frame=CL_repres$frames["B"], filename = "./01_FOXP1_dataset/Cluster_B.pdb")
```
